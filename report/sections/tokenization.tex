...
It is important to remember that NFAs can be in multiple states at any given point. For this reason we will collaps some states into a single state symbolising the NFA being in multiple states at once.
